...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface-secondary border-t border-border-primary mt-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            {socialLinks.map((social) => (
              <a
                ...
                className="p-2 text-text-secondary hover:text-brand-primary transition-colors rounded-md hover:bg-surface-primary"
