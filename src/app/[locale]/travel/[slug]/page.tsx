...
export default async function TravelArticlePage({ params }: PageProps) {
  ...
  const articleUrl = `${SITE_CONFIG.baseUrl}/${locale}/travel/${slug}`;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        {/* Breadcrumbs */}
        <Breadcrumbs category="travel" articleTitle={frontmatter.title} locale={locale} articleSlug={slug} />
