...
export default async function MotoGPArticlePage({ params }: PageProps) {
  ...
  const articleUrl = `${SITE_CONFIG.baseUrl}/${locale}/motogp/${slug}`;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        {/* Breadcrumbs */}
        <Breadcrumbs category="motogp" articleTitle={frontmatter.title} locale={locale} articleSlug={slug} />
